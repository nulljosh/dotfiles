...
---
`python3 ~/.claude/skills/lec-review/review.py` prints each quiz with its submitted answers and any coach notes, newest first. Then explain the misses in plain language, one concept per miss, and suggest what to practice. If the log is empty, say no quiz has been recorded yet.
