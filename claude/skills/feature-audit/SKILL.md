...
## Phase 1 — Inventory
1. Read the project's AGENTS.md/README/roadmap.md for context, then scan source for distinct user-facing features (routes/views/controllers for web apps; SwiftUI Views/Features for iOS/macOS).
