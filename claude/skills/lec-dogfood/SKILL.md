...
---
1. `sh ~/.Codex/skills/lec-dogfood/run.sh` builds, installs to /Applications, relaunches in the background (`open -g`, never steal focus), waits 25s, prints the detected course and saves a window screenshot to /tmp/lecshot/dogfood.png.
