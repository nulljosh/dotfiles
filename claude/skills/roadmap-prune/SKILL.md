...
```bash
python3 ~/.Codex/skills/roadmap-prune/scripts/prune.py <path/to/roadmap.md> [more paths...]
```
...
find ~/Documents/Code -maxdepth 2 \( -iname "roadmap.md" -o -iname "ROADMAP.md" \) -not -path "*/node_modules/*" \
  -exec python3 ~/.Codex/skills/roadmap-prune/scripts/prune.py {} +
```
...
- Doesn't touch anything outside `roadmap.md`/`ROADMAP.md` (not README/AGENTS.md).
