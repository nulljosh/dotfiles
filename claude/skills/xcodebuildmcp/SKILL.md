...
MCP server (`Codex mcp list` → `XcodeBuildMCP`) giving direct tool access to
...
## Notes
- Installed user-scoped: `Codex mcp add XcodeBuildMCP -s user -- npx -y xcodebuildmcp@latest mcp`.
