...
- [x] Test Spark iOS on iPhone (v2.1.0 shipped)
- [x] Test Tally iOS on iPhone (v2.3.0 shipped, macOS + watchOS too)
- [x] Add health grading to Dose iOS (v2.4.0)
- [x] Bump Monica, Spark, Tally, and Dose iOS
- [x] Start Rabbit, Portfolio, Journal, and Dashboard iOS (portfolio-ios started)
- [x] Standardize CLAUDE.md across all repos
- [x] Consolidate repos (23 standalone + 4 monorepos, bots + jot absorbed into systems)

### Tier 2: Features
- [ ] Add events, flights, news, sports, maps, and nav to Monica
- [x] Expand Tally reports and sync iOS Notes contacts
- [x] Import iOS health data into Dose
- [x] Reorder Dose entries by relevance
- [x] Arthur quantization pipeline + BPE tokenizer v2

### Tier 3: New Projects
- [x] Usage tracker (started in apps monorepo)
- [ ] OpenClaw pin caching fix
- [x] Compass card bot (balance + trip history)
- [x] Dominos ordering bot
- [x] Weedbot stash tracker

### Tier 4: Future
- [ ] HN + X monitor, Josh Code, Vibe clone, Browser, Langs, NullOS, Hardware

### Commands + Bots
- [x] /safety, /security, /simplify NL suggestions
...
- **Now (late Mar 2026)**: Monica, Tally, Spark, Dose, Arthur all shipped with iOS/macOS companions. 10 standalone + 3 monorepos. Bots and stubs absorbed. About $7K debt.
- **Apr 2026**: UVIC transfer app deadline (Apr 15 for May entry). Ship remaining iOS apps to TestFlight.
- **Summer 2026**: College prep, save for MacBook + car + dog
...
### TODO
- [x] Integrate into Tally (PWD tracker in v2.3.0)
